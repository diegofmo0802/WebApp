...
- Si harás la lógica en una etiqueta HTML:
  ```html
  <script type="module">
    import WebApp from 'https://diegofmo0802.github.io/WebApp/WebApp.js';
  </script>
  ```
...
- Para crear un elemento div con clase "contenedor"
  ```js
  import { Elemento } from 'https://diegofmo0802.github.io/WebApp/WebApp.js';
...
- Petición GET para ver mis proyectos.
  ```js
  import { Ajax } from 'https://diegofmo0802.github.io/WebApp/WebApp.js';
